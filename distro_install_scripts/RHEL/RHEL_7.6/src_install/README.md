## Tools to Install ROCm 2.0.0 on RHEL 7.6 From Source
The scripts in this directory will download, build, and install ROCm 2.0.0 from source on RHEL 7.6.
...
```bash
./03_install_rocm_libraries_rhel_7.6.sh
```
...
```bash
./00_prepare_system_rhel_7.6.sh -r
```
...
```bash
./01_install_rocm_rhel_7.6.sh -l -i {rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_rhel_7.6.sh -r
```
...
```bash
./03_install_rocm_libraries_rhel_7.6.sh -l -i ${rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./01_install_rocm_rhel_7.6.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_rhel_7.6.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
