## Tools to Install ROCm 1.9.2 on Ubuntu 16.04 From Source
The scripts in this directory will download, build, and install ROCm 1.9.2 from source on Ubuntu 16.04.5 LTS.
