## Tools to Install ROCm 1.9.1 on Ubuntu 18.04 From Source
The scripts in this directory will download, build, and install ROCm 1.9.1 from source on Ubuntu 18.04.1 LTS.
