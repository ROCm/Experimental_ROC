## Install ROCm 2.0.0 on Ubuntu 18.10 Using APT
The scripts in this directory will install ROCm 2.0.0 on Ubuntu 18.10
...
#### Updating the Kernel
The following script will prepare the system for ROCm 2.0.0 by updating the kernel on your system to its newest version.
