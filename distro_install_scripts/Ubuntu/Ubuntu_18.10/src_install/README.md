## Tools to Install ROCm 1.9.2 on Ubuntu 18.10 From Source
The scripts in this directory will download, build, and install ROCm 1.9.2 from source on Ubuntu 18.10.
...
```bash
./00_prepare_system_ubuntu_18.10.sh
```
...
```bash
./01_install_rocm_ubuntu_18.10.sh
```
...
```bash
./03_install_rocm_libraries_ubuntu_18.10.sh
```
...
```bash
./00_prepare_system_ubuntu_18.10.sh -r
```
...
```bash
./01_install_rocm_ubuntu_18.10.sh -r
```
...
```bash
./01_install_rocm_ubuntu_18.10.sh -l -i {rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_ubuntu_18.10.sh -r
```
...
```bash
./03_install_rocm_libraries_ubuntu_18.10.sh -l -i ${rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./01_install_rocm_ubuntu_18.10.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_ubuntu_18.10.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
