## Install ROCm 1.9.1 on CentOS 7.5 Using Yum
The scripts in this directory will install ROCm 1.9.1 on CentOS 7.5.
...
#### Updating the Kernel
The following script will prepare the system for ROCm 1.9.1 by updating the kernel on your system to its newest version and installing the Developer Toolset 7 software collection.
