## Tools to Install ROCm 1.9.1 on CentOS 7.5 From Source
The scripts in this directory will download, build, and install ROCm 1.9.1 from source on CentOS 7.5.
