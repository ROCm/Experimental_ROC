## Tools to Install ROCm 1.9.2 on Fedora 28 From Source
The scripts in this directory will download, build, and install ROCm 1.9.2 from source on Fedora 28.
...
```bash
./00_prepare_system_fedora_28.sh -r
```
...
```bash
./01_install_rocm_fedora_28.sh -r
```
...
```bash
./01_install_rocm_fedora_28.sh -l -i {rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_fedora_28.sh -r
```
...
```bash
./03_install_rocm_libraries_fedora_28.sh -l -i ${rocm_installation_directory} -o {rocm_installation_directory}
```
...
```bash
./01_install_rocm_fedora_28.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
...
```bash
./03_install_rocm_libraries_fedora_28.sh -p {directory_to_store_packages} -o {rocm_installation_directory}
```
