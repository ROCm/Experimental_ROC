...
BuildRoot: /home/jgreatho/.tmp/rpmrebuild.21053/work/root
AutoProv: no
...
Provides:      rocm-dkms = ROCM_PKG_VERSION-1
Provides:      rocm-dkms(x86-64) = ROCM_PKG_VERSION-1
Requires:      /bin/sh
Requires:      /bin/sh
Requires:      /bin/sh
Requires:      /bin/sh
...
%attr(0644, root, root) "ROCM_OUTPUT_DIR/.info/version"
%pre -p /bin/sh
%post -p /bin/sh
